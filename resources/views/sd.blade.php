...
<head>
    ...
    <title>SD - Sekolah Alam Cibinong</title>
...
<nav class="bg-green-500 p-2 sticky top-0 z-50">
    ...
    <div class="container mx-auto">
        ...
        <div class="bg-green-500 text-white py-3 px-4 rounded-t-lg w-full md:w-1/3 mx-auto">
            <h2 class="font-bold text-xl text-center">SD SAI Cibinong</h2>
        </div>
...
<div class="container mx-auto px-4 md:px-8">
    <div class="grid grid-cols-1 gap-6 mt-4">
        <div class="flex flex-col md:flex-row items-center gap-10">
            ...
            <div class="p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                <img src="{{ asset('img/our5.jpg') }}" alt="Team Member 4" class="w-full h-64 object-cover rounded-lg shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out">
            ...
            <div class="max-w-2xl leading-relaxed text-justify">
                <h3 class="font-bold text-lg">Sekolah Dasar</h3>
                <p class="text-black">
    ...
    <!-- List Program Utama dengan Gambar -->
<div class="ml-8 mt-4 mb-11">
    <ul class="list-disc list-inside text-black">
        <li>
            <span class="font-bold">Rabu Ceria:</span> Kegiatan outdoor dan snack bersama
            <!-- Gambar untuk Rabu Ceria -->
            <img src="{{ asset('img/kg3.jpg') }}" alt="Rabu Ceria" class="mt-2 w-96 h-auto ml-10">
        </li>
        <li>
            <span class="font-bold">Kegiatan Ibadah:</span> Shalat dhuha, Shalat dzuhur berjamaah, Tahsin, dan Tahfidz
            <!-- Gambar untuk Kegiatan Ibadah -->
            <img src="{{ asset('img/kegiatan_ibadah.jpg') }}" alt="Kegiatan Ibadah" class="mt-2 w-64 h-auto">
        </li>
        <li>
            <span class="font-bold">Outing:</span> Kegiatan belajar langsung ke lokasi belajar
            <!-- Gambar untuk Outing -->
            <img src="{{ asset('img/sd.jpg') }}" alt="Outing" class="mt-2 w-64 h-auto ml-10">
        </li>
        <li>
            <span class="font-bold">OTFA (out trekking fun adventure):</span> Kegiatan menginap atau kemping di luar sekolah
            <!-- Gambar untuk OTFA -->
            <img src="{{ asset('img/otfa.jpg') }}" alt="OTFA" class="mt-2 w-64 h-auto ml-10">
        </li>
        <li>
            <span class="font-bold">Selebrasi Tema:</span> Kegiatan puncak dari Project Based Learning
            <!-- Gambar untuk Selebrasi Tema -->
            <img src="{{ asset('img/selebrasi_tema.jpg') }}" alt="Selebrasi Tema" class="mt-2 w-64 h-auto">
        </li>
    </ul>
</div>
